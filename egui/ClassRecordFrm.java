 ...
 * @author Marvin
 */
public class ClassRecordFrm extends javax.swing.JFrame {
     ...
     */
    public ClassRecordFrm(String subjectname,String sid,int w_works,int p_task,int q_ass) {
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(jTabbedPane1, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 1408, Short.MAX_VALUE)
            .addComponent(jPanel3, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(subjectname, javax.swing.GroupLayout.PREFERRED_SIZE, 115, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
    ...
    private void settable(){
        try{
            ...
            while(rsq.next())
             ...
             String sql1="SELECT * FROM tbl_rawscore left join tbl_grading on tbl_rawscore.grade_id = tbl_grading.grade_id left JOIN tbl_students ON tbl_rawscore.s_ID = tbl_students.s_ID where quarter = '1st Quarter' and sub_id = "+sub_id+" order by tbl_students.s_lname ASC";
             stmt1.execute(sql1);
             String temp = "";
             String name="";
             int q[] = new int[5];
             ...
             while(rs1.next()){
                 ...
                 name =rs1.getString("s_lname")+" "+ rs1.getString("s_fname");
                 finalgrade[studs][0]=name;
                    try{
                               ...
                               ResultSet rs4 = stmt4.getResultSet();
                                ...
                                if(temp.equals("") || !temp.equals(id)){
                                         ...
                                         finalgrade[studs][1]=Double.toString(round(((perc*(wworks/100))+(perc2*(ptask/100)) + (perc3*(qass/100)) )));
                                        if(finalgrade[studs][1] == null){
                                            finalgrade[studs][1] = "0";
                                        }
                                         
                                         model.addRow(new Object[]{name,q[0],q[1],q[2],q[3],q[4],total2,df2.format(perc),w[0],w[1],w[2],w[3],w[4],total3,df2.format(perc2),r,df2.format(perc3),finalgrade[studs][1]});
                                        total2=0;
                                        total3=0;
                                        y=0;
                                        studs++;
        ...
        try{
           ...
           Statement stmtq = conn.createStatement();
            ...
            while(rsq.next())
             ...
             Statement stmt1 = conn.createStatement();
             String sql1="SELECT * FROM tbl_rawscore left join tbl_grading on tbl_rawscore.grade_id = tbl_grading.grade_id left JOIN tbl_students ON tbl_rawscore.s_ID = tbl_students.s_ID where quarter = '2nd Quarter' and sub_id = "+sub_id+" order by tbl_students.s_lname ASC";
             stmt1.execute(sql1);
             String temp = "";
             String name="";
             int q[] = new int[5];
                 ...
                 name =rs1.getString("s_lname")+" "+ rs1.getString("s_fname");
                    try{
					 ...
					 while(rs4.next()){
                                        ...
                                        finalgrade[studs][2]=Double.toString(round(((perc*(wworks/100))+(perc2*(ptask/100)) + (perc3*(qass/100)) )));
                                        if(finalgrade[studs][2] == null){
                                            finalgrade[studs][2] = "0";
                                        }
                                        
                                        model.addRow(new Object[]{name,q[0],q[1],q[2],q[3],q[4],total2,df2.format(perc),w[0],w[1],w[2],w[3],w[4],total3,df2.format(perc2),r,df2.format(perc3),finalgrade[studs][2]});
                                        total2=0;
                                        total3=0;
                                        y=0;
                                        studs++;
        ...
        try{
           ...
           Statement stmtq = conn.createStatement();
            ...
            while(rsq.next())
             ...
             model.addRow(new Object[]{"Highest Possible Score",hscore[0],hscore[1],hscore[2],hscore[3],hscore[4],total,"100%",hscore2[0],hscore2[1],hscore2[2],hscore[3],hscore2[4],totalp,"100%",exam});
             model.addRow(new Object[]{" "});
             
             Statement stmt1 = conn.createStatement();
             String sql1="SELECT * FROM tbl_rawscore left join tbl_grading on tbl_rawscore.grade_id = tbl_grading.grade_id left JOIN tbl_students ON tbl_rawscore.s_ID = tbl_students.s_ID where quarter = '3rd Quarter' and sub_id = "+sub_id+" order by tbl_students.s_lname ASC";
             stmt1.execute(sql1);
             String temp = "";
             String name="";
             int q[] = new int[5];
                 ...
                 name =rs1.getString("s_lname")+" "+ rs1.getString("s_fname");
                    try{
					 ...
					 while(rs4.next()){
                                         ...
                                         finalgrade[studs][3]=Double.toString(round(((perc*(wworks/100))+(perc2*(ptask/100)) + (perc3*(qass/100)) )));
                                         if(finalgrade[studs][3] == null){
                                            finalgrade[studs][3] = "0";
                                        }
                                         
                                         model.addRow(new Object[]{name,q[0],q[1],q[2],q[3],q[4],total2,df2.format(perc),w[0],w[1],w[2],w[3],w[4],total3,df2.format(perc2),r,df2.format(perc3),finalgrade[studs][3]});
                                        total2=0;
                                        total3=0;
                                        total4=0;
                                        y=0;
        ...
        try{
           ...
           Statement stmtq = conn.createStatement();
            ...
            while(rsq.next())
             ...
             Statement stmt1 = conn.createStatement();
             String sql1="SELECT * FROM tbl_rawscore left join tbl_grading on tbl_rawscore.grade_id = tbl_grading.grade_id left JOIN tbl_students ON tbl_rawscore.s_ID = tbl_students.s_ID where quarter = '4th Quarter' and sub_id = "+sub_id+" order by tbl_students.s_lname ASC";
             stmt1.execute(sql1);
             String temp = "";
             String name="";
             int q[] = new int[5];
                    ...
                    try{
                               ...
                               ResultSet rs4 = stmt4.getResultSet();
                                ...
                                if(temp.equals("") || !temp.equals(id)){
                                         ...
                                         finalgrade[studs][4]=Double.toString(round(((perc*(wworks/100))+(perc2*(ptask/100)) + (perc3*(qass/100)) )));
                                        if(finalgrade[studs][4] == null){
                                            finalgrade[studs][4] = "0";
                                        }
                                         
                                         model.addRow(new Object[]{name,q[0],q[1],q[2],q[3],q[4],total2,df2.format(perc),w[0],w[1],w[2],w[3],w[4],total3,df2.format(perc2),r,df2.format(perc3),finalgrade[studs][4]});
                                        total2=0;
                                        total3=0;
                                        total4=0;
                                        y=0;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ClassRecordFrm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new ClassRecordFrm("","",0,0,0).setVisible(true);
            }
        });
    }
